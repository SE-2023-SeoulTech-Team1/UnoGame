...
class MultiSettingPage():
    def __init__(self, screen, setting):
        ...
        self.btn_pwd = TextButton(0.5, 0.5, 200, 50, "Password")
        self.btn_input_pwd = TextButton(0.5, 0.6, 200, 50, "")
        self.btn_submit_pwd = Button(0.5, 0.7, 200, 50, "Submit")
                ...
                if event.type == pygame.QUIT:
                    ...
                    if self.btn_submit_pwd.rect.collidepoint(event.pos):
                        if self.btn_input_pwd.text is not "":
                            client = self.btn_input_pwd.text
                            self.compare_ip(1, "1234", client)
